...
class Widget_Thz_Instagram extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'description' => esc_html__( 'Instagram images widget', 'creatus-extended' ) );
		parent::__construct( false, esc_html__( 'Creatus - Instagram images', 'creatus-extended' ), $widget_ops );
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'Username:', 'creatus-extended' ); ?></label>

            ...
            <div class="<?php echo $prefix; ?>pred-tpl-cat">
                <div class="<?php echo $prefix; ?>pred-tpl-menu-holder">
                	<div class="<?php echo $prefix; ?>pred-tpl-menu-title">
                        ...
                        <span class="title"><?php esc_html_e('Template Library', 'creatus-extended') ?></span>
                        <div class="tsearch-container">
                        	<input id="tsearch" name="search" class="tsearch" placeholder="<?php esc_html_e('Quick search', 'creatus-extended') ?>" type="text" data-list=".thz-theme-pred-tpl-thumb-list-inner">
                    ...
                    <ul id="<?php echo esc_attr($select_id) ?>" class="<?php echo $prefix; ?>pred-tpl-cat-select">
                        <li>
                            <a class="active" href="#" data-val="">
                                <?php esc_html_e('All Categories', 'creatus-extended') ?> 
        ...
        <?php if ($sections): ?>
            <div class="<?php echo $prefix; ?>pred-tpl-thumb-list">
                            ...
                            <div class="<?php echo $prefix; ?>pred-tpl-item-title">
                                <?php if ( isset($section['type']) && !$cpac ): ?>
                                 <a class="<?php echo $prefix; ?>get-cp-link" href="https://themezly.com/pricing/" target="_blank">
                                    <?php esc_html_e('Go Pro', 'creatus-extended') ?>
                                 </a>
                                <?php endif; ?>
                ...
                <div class="<?php echo $prefix; ?>pred-tpl-lib-update">
                    <span class="last-update"><?php echo esc_html__('Last updated', 'creatus-extended').' '. thz_ago( $last_update ) ?></span>
                    <a href="#" class="force-update" title="<?php esc_html_e('Force Library Update', 'creatus-extended') ?>">
